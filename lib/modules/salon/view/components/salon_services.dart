  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      slivers: [
        ...
        SliverToBoxAdapter(
          child: Obx(
            () => controller.salonCategories.isEmpty
                          ...
                          ? GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color:
                                        controller.selectedCategory.value == 0 ? AppColors.primary : AppColors.gray200,
                                  ),
                                ),
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    CustomText(
                                      ...
                                      fontSize: 10,
                                      color:
                                          controller.selectedCategory.value == 0 ? AppColors.primary : AppColors.black,
                                      maxLines: 1,
                                    ),
                                  ],
                                ),
                          ...
                          : GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(10),
                                  border: Border.all(
                                    color: controller.selectedCategory.value == controller.salonCategories[index - 1].id
                                        ? AppColors.primary
                                        : AppColors.gray200,
                                  ),
                                ),
