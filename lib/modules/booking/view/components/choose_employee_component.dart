    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: controller.bookingBody.salon!.employees.isEmpty
              ? CustomEmptyListSmallWidget(title: AppStrings.noWorkers.tr, image: AppImages.emptyBooking)
              : ListView.separated(
                  scrollDirection: Axis.horizontal,
                  padding: const EdgeInsets.symmetric(horizontal: AppPadding.p16),
                  itemCount: controller.bookingBody.salon!.employees.length,
                  separatorBuilder: (context, index) => const HorizontalSpace(AppSize.s6),
                  itemBuilder: (context, index) => BookEServiceEmployeeWidget(
                    controller.bookingBody.salon!.employees[index],
                  ),
                ),
        ),
      ],
