...
class AppColors {
  ...
  static const Color grey100 = Color(0xFFF6F5F5);
  static const Color gray200 = Color(0xffe4e3e3);
  static const Color gray250 = Color(0xffe0e0e0);
  ...
  static const Color open = Color(0xFF36AE7C);
